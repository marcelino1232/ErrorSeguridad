...
namespace ManejoPresupuesto.Servicios
{
    public class UsuarioStore : IUserStore<Usuario>,
        IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        private readonly UsuarioRepository usuarioRepository;

        public UsuarioStore(UsuarioRepository usuarioRepository)
        {
        ...
        {
            return await usuarioRepository.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await usuarioRepository.BuscarUsuarioPorEmail(normalizedUserName);
        }
